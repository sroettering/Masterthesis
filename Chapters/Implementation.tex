...
This chapter gives an overview of the implementation of the smartwatch controlled mobile music player. It creates an insight into the chosen interaction techniques, the mobile-wear communication and the core music player functions.
...
\section{Prototype Structure}\label{sec:PrototypeStructure}
TODO: describe and explain components of each app and show diagram of each.
...
% create app structure diagram and show in intro

% describe spotify usage
