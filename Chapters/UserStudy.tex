...
\begin{figure}[h]
	...
	\includegraphics[width=1\linewidth]{img/priorityScenarios.pdf}} \\
	\subfloat[Averaged priority rating for the input techniques for every task]
	{\label{fig:priorityTasks}
	\includegraphics[width=1\linewidth]{img/priorityTasks.pdf}}
...
\begin{figure}[h]
	...
	\includegraphics[width=1\linewidth]{img/scenarioUsage.pdf}} \\
	\subfloat[Amount of most made choices for each task.]
	{\label{fig:taskUsage}
	\includegraphics[width=1\linewidth]{img/taskUsage.pdf}}
...
\begin{figure}[h]
	...
	\includegraphics[width=.55\linewidth]{img/perceivedControl.pdf}} \\
	\subfloat[Overall usage numbers of each input technique for all participants.]
	{\label{fig:overallUsage}
	\includegraphics[width=.55\linewidth]{img/overallUsage.pdf}}
	\caption{}
...
\begin{figure}[h]
	...
	\includegraphics[width=1\linewidth]{img/requiredPhysicalEffort.pdf}} \\
	\subfloat[Required amount of attention in each scenario.]
	{\label{fig:requiredAttention}
	\includegraphics[width=1\linewidth]{img/requiredAttention.pdf}}
